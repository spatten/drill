...
fn show_stats(list_reports: &[Vec<Report>], stats_option: bool, nanosec: bool, duration: f64) {
  ...
  println!("total_requests: {}, duration: {}, requests_per_second: {}", global_stats.total_requests, duration, requests_per_second);
  println!("median time per request: {}", global_stats.median_duration_ms());
  ...
  println!("{:width2$} {}", "Median time per request".yellow(), format_time(global_stats.median_duration_ms() * 1000.0, nanosec).purple(), width2 = 25);
  println!("{:width2$} {}", "Average time per request".yellow(), format_time(global_stats.mean_duration_ms() * 1000.0, nanosec).purple(), width2 = 25);
  println!("{:width2$} {}", "Sample standard deviation".yellow(), format_time(global_stats.stdev_duration_ms() * 1000.0, nanosec).purple(), width2 = 25);
  println!("{:width2$} {}", "99.0'th percentile".yellow(), format_time(global_stats.value_at_quantile_ms(0.99) * 1000.0, nanosec).purple(), width2 = 25);
  println!("{:width2$} {}", "99.5'th percentile".yellow(), format_time(global_stats.value_at_quantile_ms(0.995) * 1000.0, nanosec).purple(), width2 = 25);
  println!("{:width2$} {}", "99.9'th percentile".yellow(), format_time(global_stats.value_at_quantile_ms(0.999) * 1000.0, nanosec).purple(), width2 = 25);
}
